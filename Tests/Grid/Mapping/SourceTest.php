...
class SourceTest extends TestCase
{
    ...
    public function testSetterColumnsWithDefaultValue()
    {
    ...
    public function testSetterFilterableWithDefaultValue()
    {
        $this->assertAttributeEquals(
            true,
            'filterable',
    ...
    public function testSetterSortableWithDefaultValue()
    {
        $this->assertAttributeEquals(
            true,
            'sortable',
    ...
    public function testSetterGroupsWithDefaultValue()
    {
    ...
    public function testSetterGroupByWithDefaultValue()
    {
        $this->assertAttributeEquals(
            [],
            'groupBy',
