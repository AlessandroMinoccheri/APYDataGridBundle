...
class MetadataTest extends TestCase
{
    ...
    public function testSetterFieldMappingsWithField()
    {
        $fieldRandom = 'foo';
        $valueRandom = 'bar';
    ...
    public function testHasFieldMappingWithField()
    {
        ...
        $this->assertTrue($this->metadata->hasFieldMapping($fieldRandom));
        $this->assertFalse($this->metadata->hasFieldMapping('notAddedField'));
    }

    public function testGetterFieldMappingWithField()
    {
        $fieldRandom = 'foo';
        $valueRandom = 'bar';
        $fieldMapping = [$fieldRandom => $valueRandom];
        ...
        $this->assertEquals(
            $valueRandom, 
            $this->metadata->getFieldMapping($fieldRandom)
        );
    }
    ...
    public function testGetterFieldMappingReturnDefaultTypeText()
    {
        ...
        $this->assertEquals(
            'text',
            $this->metadata->getFieldMappingType($fieldRandom)
        );
    }
    ...
    public function testGetterMappingFieldWithType()
    {
        ...
        $this->metadata->setFieldsMappings($fieldMapping);
        $this->assertEquals($value, $this->metadata
            ->getFieldMappingType($field));
    }

    public function testSetterGroupByWithString()
    {
        $groupBy = 'groupBy';
    ...
    public function testGetterGroupByWithString()
    {
        $groupBy = 'groupBy';
    ...
    public function testSetterNameWithString()
    {
        $name = 'name';
    ...
    public function testGetterNameWithString()
    {
        $name = 'name';
